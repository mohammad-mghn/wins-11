...
import batteryBack from "../../assets/icons/battery-empty.svg";
import batteryFilled from "../../assets/icons/battey-full.svg";
import batteryCharge from "../../assets/icons/battery-charging.svg";
...
const BatteryStatus = ({ PREFIX }: { PREFIX?: string }) => {
  ...
  return (
    <>
      <img
        src={batteryBack}
        className={PREFIX + "-battery-back  icon"}
        alt=""
      />
      <span
        className={PREFIX + "-battery-filled-container"}
        style={{ width: `${batteryChargeWidth}rem` }}
      >
        <img
          src={batteryFilled}
          className={PREFIX + "-battery-filled icon"}
          alt=""
        />
      </span>
      {isCharging && (
